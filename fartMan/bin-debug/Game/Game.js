...
var GameInstance = (function (_super) {
    ...
    function GameInstance() {
        ...
        _this.mIsMapStarted = false;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.AddGameToStage, _this);
        _this.addEventListener(egret.Event.ENTER_FRAME, _this.Update, _this);
        _this.mTimeOnEnterFrame = egret.getTimer();
        return _this;
    }
    GameInstance.prototype.AddGameToStage = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.SetCurrentMap("resource/cute.tmx")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    GameInstance.prototype.Update = function () {
        ...
        var pass = now - this.mTimeOnEnterFrame;
    ...
    GameInstance.prototype.UpdateMapTransition = function () {
    ...
    GameInstance.prototype.SetCurrentMap = function (mapID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // TODO 可能会出问题
...
__reflect(GameInstance.prototype, "GameInstance");
